export const APPROVAL_PRESETS = { // context: { currentFormLabel?, targetFormLabel?, isPending? }
    "link-add": {
        ...
        approveLabel: (ctx) =>
            ctx.isPending ? "Bağlanıyor..." : "Bağlantıyı onayla",
        rejectLabel: () => "Vazgeç",
    },
    ...
    "link-change": {
        ...
        approveLabel: (ctx) =>
            ctx.isPending ? "Güncelleniyor..." : "Bağlantıyı değiştir",
        rejectLabel: () => "Vazgeç",
    },
    ...
    "link-remove": {
        ...
        approveLabel: (ctx) =>
            ctx.isPending ? "Kaldırılıyor..." : "Bağlantıyı kaldır",
        rejectLabel: () => "Vazgeç",
    },
    ...
    "delete-form": {
        ...
        approveLabel: (ctx) =>
            ctx.isPending ? "Siliniyor..." : "Formu sil",
        rejectLabel: () => "İptal",
    },
    ...
    default: {
        ...
        highlights: () => [],
        approveLabel: (ctx) =>
            ctx.isPending ? "İşleniyor..." : "Onaylıyorum",
        rejectLabel: () => "İptal",
    },
};
