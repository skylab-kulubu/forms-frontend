...
import { CheckCircle2, CircleGauge, CircleAlert, RotateCcw, Share2, Trash, Trash2, Plus } from "lucide-react";
...
export function LibraryItem({ item, onSelect, layout = "grid" }) {
    ...
    return (
        ...
        >
            {justAdded && (
                <motion.div layoutId="added-flash" className="absolute inset-0 z-10 rounded-xl bg-emerald-500/20 border-2 border-emerald-500/50 pointer-events-none"
