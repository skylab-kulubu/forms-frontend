                    ...
                    <div className="ml-auto flex items-center gap-1 text-neutral-500">
                        ...
                        {showShare ? (
                            <button type="button" aria-label="Formu paylas" onClick={onShare} disabled={!onShare}
                                className={`rounded-lg p-1.5 transition-colors ${onShare ? "" : "opacity-50 cursor-not-allowed"} ${shareStatus === "success" ? "text-skylab-400" : shareStatus === "error" ? "text-red-400" : "hover:text-neutral-100 hover:bg-neutral-800/70"}`}
                            >
                                <Share2 size={16} />
                            </button>
                        ) : null}
